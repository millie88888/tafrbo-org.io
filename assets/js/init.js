    ...
    */
      ...
      $("#contactForm").validator().on("submit", function (event) {
          if (event.isDefaultPrevented()) {
            ...
            formError();
            submitMSG(false, "Did you fill in the form properly? 請確認資料是否填寫正確，感謝您！");
          } else {
      ...
      if( $('#ch-map').length ) {
          ...
          function init() {
              var mapOptions = {
                  ...
                  center: new google.maps.LatLng(39.0838889, -77.1530556), // Rockville, MD
              ...
              var marker = new google.maps.Marker({
                  position: new google.maps.LatLng(39.0838889, -77.1530556),
                  map: map,
                  title: 'Charity!'
              });
          }
